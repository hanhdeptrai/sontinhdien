...
<!-- BEGIN: breadcrumbs -->
<div id="tms_breadcrumbs" style="background-color:#f2f2f2; background-image: url({NV_BASE_SITEURL}uploads/{MODULE_BG}.jpg); background-size: cover; background-position: center center;background-repeat: no-repeat;"> 
<div class="wraper">
<div class="container">
<ul>
