...
$lang_module['upload_blocked'] = 'Le transfert de fichier image est interdit par le système, donc vous ne pouvez pas ajouter les publicités. Vérifiez la configuration du site ou l\'autorisation des fichiers transférés.';
