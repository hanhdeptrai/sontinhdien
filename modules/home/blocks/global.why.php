...
if (!nv_function_exists('nvb_why')) {
     ...
     * @return string
     */
    function nvb_config_why($module, $data_block, $lang_block)
    {
     ...
     * @return number
     */
    function nvb_config_why_submit($module, $lang_block)
    {
        global $nv_Request;
    ...
    function nvb_why($block_config)
    {
        ...
        if (isset($site_mods[$mod_name])) {
            ...
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $mod_file . '/global.why.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $mod_file . '/global.why.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('global.why.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
