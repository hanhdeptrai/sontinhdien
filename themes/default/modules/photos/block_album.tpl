...
<div class="block_album_tab_new" >
	<ul class="tms-tabs" role="tablist" id="block_album_tab_new_{BLOCK_ID}">
		...
		<div role="tabpanel" class="tab-pane" id="{TABS.alias}" style="padding: 10px">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8 col-md-6" style="margin-bottom: 15px">
					<a href="{DATA.link}" title="{DATA.name}"><img src="{DATA.thumb}" alt="{DATA.name}" /></a>
				</div>
				<!-- END: loop -->
				<!-- BEGIN: gallery -->
				<div class="col-xs-12 col-sm-8 col-md-6" style="margin-bottom: 15px">
			...
			<div class="booking"><a href="{TABS.link_album}" title="{TABS.name}"class="booking_bnt" style="text-align:center"> {LANG.more} </a></div>
