...
$lang_module['sendmail_welcome'] = 'Bonjour! Votre ami %s aimerait vous présenter l\'article “%s” sur le site %s.';
$lang_module['sendmail_welcome1'] = 'Bonjour! Votre ami %s aimerait vous présenter l\'article “%s” sur le site %s avec le message:<br/>%s';
...
$lang_module['author_description'] = 'La description';
