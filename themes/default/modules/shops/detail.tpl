...
<div class="product-detail <!-- BEGIN: popupid -->prodetail-popup<!-- END: popupid -->" itemtype="http://schema.org/Product" itemscope>
    ...
    <div class="shops_panel">
        <div class="shops_panel_heading">{LANG.detail_others}</div>
        <div class="shops_panel_body">{OTHER}</div>
    </div>
    <!-- END: other -->
    <!-- BEGIN: other_view -->
    <div class="shops_panel">
        <div class="shops_panel_heading">{LANG.detail_others_view}</div>
        <div class="shops_panel_body">{OTHER_VIEW}</div>
    </div>
    <!-- END: other_view -->
    <!-- END: product_detail -->
</div>
