 ...
 * @copyright (C) 2009-2023 TMS Holdings. All rights reserved
...
define('NV_MAX_HEIGHT', 1900);
define('NV_MAX_WIDTH', 1900);
...
$global_config['autocheckupdate'] = 0;
...
$global_config['ftp_user_pass'] = 'hrL5UVHzUGQrxCr2ayTCLA,,';
...
$global_config['my_domains'] = 'localhost,banhdanem.thuongmaiso.net';
...
$global_config['nv_max_size'] = 11658067968;
...
$global_config['rewrite_op_mod'] = 'shops';
$global_config['rewrite_optional'] = 1;
$global_config['session_prefix'] = 'nv4s_a0SKd1';
...
$global_config['timestamp'] = 1692849585;
