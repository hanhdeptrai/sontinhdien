...
$lang_module['account_register_openid_info'] = 'Bonjour %1$s,<br /><br />Votre compte sur le site Web %2$s est activé.<br/>Pour vous connecter à votre compte, veuillez visiter la page: <a href="%3$s">%3$s</a> et appuyez sur le bouton: Connectez-vous avec %4$s.<br /><br /><strong>Note importante:</strong> Vous n\'avez pas créé de mot de passe pour votre compte, vous ne pouvez donc pas vous connecter à votre compte de la manière habituelle. Veuillez créer un mot de passe dans la zone des paramètres de votre compte.<br/><br/>Cela est un message automatique qui était envoyé à votre boîte mail à partir du site %2$s. Si vous ne comprenez pas le contenu de ce mail, vous pouvez simplement le supprimer .<br /><br />Administration du site';
