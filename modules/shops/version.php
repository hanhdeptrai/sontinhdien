...
$module_version = array(
    ...
    'modfuncs' => 'main,viewcat,detail,san-pham,search,cart,order,payment,complete,history,group,search_result,compare,wishlist,tag,point,shippingajax,download, blockcat,ajax',
