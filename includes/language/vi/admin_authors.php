...
$lang_module['susp_reason_empty'] = 'Bạn chưa khai báo lý do đình chỉ hoạt động của tài khoản Quản trị &ldquo;<strong>%s</strong>&rdquo;';
$lang_module['suspend_info_empty'] = 'Tài khoản quản trị &ldquo;<strong>%s</strong>&rdquo; chưa bị đình chỉ hoạt động lần nào';
$lang_module['suspend_info_yes'] = 'Danh sách các lần đình chỉ hoạt động của tài khoản quản trị &ldquo;<strong>%s</strong>&rdquo;';
