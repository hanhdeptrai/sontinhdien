    ...
    <header id="header" class="row">
        <div class="logo">
            <a title="{NV_SITE_NAME}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}">
                <img class="logo-md" alt="{NV_SITE_NAME}" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/logo_small.png" height="50"/>
                <img class="logo-xs" alt="{NV_SITE_NAME}" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/logo-xs.png" height="50"/>
            </a>
        </div>
    ...
    <footer id="footer" class="row">
        <div class="footer-content">
            <div class="copyright">
				...
				<a title="Công Ty Cổ Phần TMS Holdings" href="http://thuongmaiso.vn" target="_blank">Thiết kế bởi TMS Holdings</a>
            </div>
