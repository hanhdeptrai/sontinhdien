...
//Document
$array_url_instruction['main'] = 'https://thuongmaiso.vn/traning/admin:menu';
$array_url_instruction['menu'] = 'https://thuongmaiso.vn/traning/admin:menu#lấy_menu_tự_dộng_từ_ten_cac_chuyen_mục_module';
$array_url_instruction['rows'] = 'https://thuongmaiso.vn/traning/admin:menu#xem_sửa_khối';
