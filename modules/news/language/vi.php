...
$lang_module['sendmail_subject'] = 'Tin nhắn từ %s';
$lang_module['sendmail_welcome'] = 'Xin chào!<br/>Bạn của bạn là %s mong muốn giới thiệu với bạn bài viết “%s” trên website %s.';
$lang_module['sendmail_welcome1'] = 'Xin chào!<br/>Bạn của bạn là %s mong muốn giới thiệu với bạn bài viết “%s” trên website %s với lời nhắn:<br/>%s';
$lang_module['sendmail_welcome2'] = 'Bạn có thể xem đầy đủ bài viết bằng cách click vào link bên dưới:<br/>%s';
