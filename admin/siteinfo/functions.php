...
//Document
$array_url_instruction['main'] = 'https://thuongmaiso.vn/traning/admin:siteinfo';
$array_url_instruction['system_info'] = 'https://thuongmaiso.vn/traning/admin:siteinfo#cấu_hinh_site';
$array_url_instruction['php_info_configuration'] = 'https://thuongmaiso.vn/traning/admin:siteinfo#cấu_hinh_php';
$array_url_instruction['php_info_modules'] = 'https://thuongmaiso.vn/traning/admin:siteinfo#tiện_ich_mở_rộng';
$array_url_instruction['php_info_environment'] = 'https://thuongmaiso.vn/traning/admin:siteinfo#cac_biến_moi_truờng';
$array_url_instruction['php_info_variables'] = 'https://thuongmaiso.vn/traning/admin:siteinfo#cac_biến_tiền_dịnh';
$array_url_instruction['logs'] = 'https://thuongmaiso.vn/traning/admin:siteinfo#nhật_ky_hệ_thống';
