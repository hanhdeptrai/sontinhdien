...
//Document
$array_url_instruction['main'] = 'https://thuongmaiso.vn/traning/admin:upload';
$array_url_instruction['thumbconfig'] = 'https://thuongmaiso.vn/traning/admin:upload:thumbconfig';
$array_url_instruction['config'] = 'https://thuongmaiso.vn/traning/admin:upload:config';
$array_url_instruction['uploadconfig'] = 'https://thuongmaiso.vn/traning/admin:upload:uploadconfig';
