...
//Document
$array_url_instruction['main'] = 'https://thuongmaiso.vn/traning/admin:database';
$array_url_instruction['file'] = 'https://thuongmaiso.vn/traning/admin:database:file';
$array_url_instruction['setting'] = 'https://thuongmaiso.vn/traning/admin:database:setting';
$array_url_instruction['sampledata'] = 'https://thuongmaiso.vn/traning/admin:database:sampledata';
