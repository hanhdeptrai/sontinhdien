...
$lang_module['logout_ok'] = 'Toàn bộ thông tin đăng nhập đã được xóa. Bạn đã thoát khỏi tài khoản thành viên';
...
$lang_module['group_type_2_note'] = 'mọi thành viên đều có thể tham gia';
$lang_module['group_manage'] = 'Quản lý nhóm';
...
$lang_module['user_id'] = 'Id đăng nhập';
...
$lang_module['not_active'] = 'Vì một lý do nào đó mà hệ thống không thể kích hoạt được tài khoản. Hãy kiểm tra lại.';
...
$lang_module['no_premission_pass'] = 'Bạn không có quyền đổi mật khẩu thành viên!';
$lang_module['info_user'] = 'Để đăng ký tài khoản, bạn cần khai báo tất cả các ô trống dưới đây';
...
$lang_module['not_del_user'] = 'Bạn không thể xóa thành viên, thành viên này đang ở một nhóm khác. Bạn chỉ có thể loại bỏ thành viên ra khỏi nhóm';
$lang_module['UserNotInGroup'] = 'Thành viên không thuộc nhóm quản lí';
