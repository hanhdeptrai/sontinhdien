                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input class="w300 form-control pull-left" type="text" value="{DATA.video}" name="video" id="video" maxlength="250" />&nbsp;<span class="text-middle"> https://www.youtube.com/watch?v=<strong style="color:red">O_qTlnLYSBU</strong> </td>
                        </tr>
                        <tr>
