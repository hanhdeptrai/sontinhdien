<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- END: js -->
		<link rel="stylesheet" type="text/css" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/tms/css/swiper.css">
		<script type="text/javascript" src="{NV_BASE_SITEURL}themes/{TEMPLATE}/tms/js/swiper.js"></script>
		<link id="theme" rel="stylesheet" type="text/css" media="all" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/tms_menu.css" />
		<script type="text/javascript" src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/tms_menu.js"></script>
