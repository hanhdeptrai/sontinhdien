...
$lang_module['adduser_register_openid_info'] = 'Hi %1$s,<br /><br />Your account at website %2$s activated.<br/>To log into your account please visit the page: <a href="%3$s">%3$s</a> and press the button: Sign in with %4$s.<br /><br /><strong>Important Note:</strong> You haven\'t created a password for your account, so you can\'t sign in to your account in the normal way. Please create a password in your account settings area.<br/><br/>This is email automatic sending from website %2$s.<br /><br />Site administrator';
