...
//Document
$array_url_instruction['main'] = 'https://thuongmaiso.vn/traning/admin:settings';
$array_url_instruction['system'] = 'https://thuongmaiso.vn/traning/admin:settings:system';
$array_url_instruction['smtp'] = 'https://thuongmaiso.vn/traning/admin:settings:smtp';
$array_url_instruction['security'] = 'https://thuongmaiso.vn/traning/admin:settings:security';
$array_url_instruction['plugin'] = 'https://thuongmaiso.vn/traning/admin:settings:plugin';
$array_url_instruction['cronjobs'] = 'https://thuongmaiso.vn/traning/admin:settings:cronjobs';
$array_url_instruction['ftp'] = 'https://thuongmaiso.vn/traning/admin:settings:ftp';
$array_url_instruction['variables'] = 'https://thuongmaiso.vn/traning/admin:setting:variables';
