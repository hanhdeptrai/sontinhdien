...
$lang_translator['copyright'] = '@Copyright (C) 2013 TMS Holdings. All rights reserved';
...
/*function album*/
$lang_module['album'] = 'Quản lý Album';
...
$lang_module['album_layout'] = 'Giao diện album';
...
$lang_module['album_error_defaults'] = 'Lỗi: Bạn phải chọn một ảnh đại diện cho album';
$lang_module['album_error_copy_photo'] = 'Lỗi di chuyển ảnh';
$lang_module['album_error_mime'] = 'Định dạng ảnh không xác định';
$lang_module['album_success_delete'] = 'Album đã được xoá thành công';
$lang_module['album_error_delete'] = 'Không có album nào được xoá';
/*function album*/

/*photo*/
$lang_module['photo_defaults'] = 'Chọn làm ảnh đại diện album';
...
$lang_module['setting_structure_upload'] = 'Thư mục lưu album ảnh';
...
$lang_module['home_view_one_album'] = 'Hiển thị 1 album';
