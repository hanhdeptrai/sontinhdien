...
//Document
$array_url_instruction['main'] = 'https://thuongmaiso.vn/traning/admin:users#quản_trị';
$array_url_instruction['add'] = 'https://thuongmaiso.vn/traning/admin:users#them_quản_trị';
$array_url_instruction['module'] = 'https://thuongmaiso.vn/traning/admin:users#quyền_hạn_quản_ly_module';
$array_url_instruction['config'] = 'https://thuongmaiso.vn/traning/admin:users#cấu_hinh';
