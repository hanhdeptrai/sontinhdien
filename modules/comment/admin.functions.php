...
//Document
$array_url_instruction['main'] = 'https://thuongmaiso.vn/traning/admin:comment';
$array_url_instruction['config'] = 'https://thuongmaiso.vn/traning/admin:comment#config';
$array_url_instruction['edit'] = 'https://thuongmaiso.vn/traning/admin:comment#edit';
